...
export async function buildAgentPreview(payload) {
...
export function humanizeAgentDismissError(agentId, errorMessage) {
    const normalized = errorMessage.trim();
    const lower = normalized.toLowerCase();
...
export async function dismissAgent(agentId) {
    try {
