import { DEFAULT_WORKSPACE_ROOT, GUI_API_BASE_PATH, GUI_ASSETS_PATH, GUI_PRODUCT_NAME, GUI_SHORT_NAME, AVATAR_MAX_BYTES, } from "./state.js";
export function renderAgentWorkShellHtml() {
    return `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
